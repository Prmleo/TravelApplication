...
@Component({
  selector: 'app-referal-approved-quotes',
  templateUrl: './referal-approved-quotes.component.html',
  styleUrls: ['./referal-approved-quotes.component.css']
})
export class ReferalApprovedQuotesComponent implements OnInit {
  ...
  getApprovedQuotes():void{
    this.apiService.getApprovedQuotes(this.id).subscribe(resultArr=>this.storeArray=resultArr,
